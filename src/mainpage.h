...
*
* @section generate 4. Generate map visibility lists
...
* visibility lists are pre-computed for the vector maps. To generate the visibility lists of the provided demo maps (to use with demo data),
* run the following commands:
@verbatim 
./bin/pre_render -m"GHC7" -n8
./bin/pre_render -m"NSH4" -n8
@endverbatim
*
* @section test 5. Testing with demo data
* The following demo data sets are available:
* -# CoBot2 in GHC7
*   - Download the ROS bag file from http://data.cobotrobots.com/cgr_localization/cobot2_ghc7.bag
*   - Modify the file config/localization_parameters.cfg, line 9 to @verbatim mapName = "GHC7"; @endverbatim
* -# CoBot2 in NSH4
*   - Download the ROS bag file from http://data.cobotrobots.com/cgr_localization/cobot2_nsh4.bag
*   - Modify the file config/localization_parameters.cfg, line 9 to @verbatim mapName = "NSH4"; @endverbatim
*
* To run the code with the demo data:
* -# Use @verbatim roslaunch cgr_localization cgr_demo.launch @endverbatim to run the localization code and display that on the bundled GUI), 
*   OR @verbatim roslaunch cgr_localization cgr_demo_rviz.launch @endverbatim to run the localization code with rviz
* -# Play back the data file with @verbatim rosbag play <bagfile.bag> --clock @endverbatim 
*
* @section robot 6. Running on your own robot
...
* maps/GHC7/GHC7_vector.txt . Each entry in the vector map represents a line in the world, and is of the form:
...
* and "scan" of type <a href="http://www.ros.org/doc/api/sensor_msgs/html/msg/LaserScan.html">sensor_msgs/LaserScan</a>
*
*
